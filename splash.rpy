...
init python:
    ...
    splash_message_default = "Once in a blue moon"
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        menu:
            "By playing [config.name] you agree that you have completed Doki Doki Literature Club and accept any spoilers contained within. Also hi!"
            "I agree.":
