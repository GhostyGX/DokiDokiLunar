...
style say_label:
    ...
    yalign 0.5
    outlines [(3, "#8A2BE2", 0, 0), (1, "#8A2BE2", 1, 1)]
    ...
    vbox:
        ...
        if not persistent.autoload or not main_menu:
            ...
            if renpy.variant("pc"):
                ...
                textbutton _("Help") action Help("IMPORTANT.txt")
...
style navigation_button_text:
    ...
    color "#ffff"
    outlines [(4, "#8A2BE2", 0, 0), (2, "#8A2BE2", 2, 2)]
    hover_outlines [(4, "#add8e6", 0, 0), (2, "#add8e6", 2, 2)]
    insensitive_outlines [(4, "#add8e6", 0, 0), (2, "#add8e6", 2, 2)]
