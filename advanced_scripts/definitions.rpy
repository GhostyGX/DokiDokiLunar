...
define audio.t1 = "mod_assets/DDLC OST Poems are Forever Shoji.ogg"  #gaming main menu msuic
...
define audio.td = "<loop 36.782>bgm/d.ogg" #omg sayori gay music not poggg uwu
...
define audio.amogus = "mod_assets/amogus.ogg" #your mom gay
...
define g = Character('Ghosty', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
